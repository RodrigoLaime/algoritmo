...
if(edad ===18) {
    ...
    console.log("podes votar de nuevo")
} else {
...
function resta (a,b) 
{
    ...
    console.log (resta(59,36));
    switch(Number) 
{
    case 1: "El número es 30" 
    break;
    case 2: "El número es 25" 
    break;
    case 3: "El número es 23"
    break;
    default: "El número es menor a 22" 
}